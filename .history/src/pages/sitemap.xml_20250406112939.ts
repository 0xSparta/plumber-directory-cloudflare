...
export const GET: APIRoute = async ({ site }) => {
  ...
  // Add top city pages (limit to 20 cities per state to keep sitemap size manageable)
  const cityPages = [];
  ...
  // Add top plumber pages (limit to 1000 plumbers to keep sitemap size manageable)
